  ...
  return (
    <section className="py-20 dark:bg-gray-900">
      <div className="max-w-4xl px-4 mx-auto">
        <h2 className="mb-12 text-[22px] md:text-[26px] font-bold text-center dark:text dark:text-white">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              <summary className="flex justify-between items-center p-5 cursor-pointer font-semibold text-md text-[#001F46] dark:text-white group-open:bg-yellow-50 dark:group-open:bg-gray-700">
                <span>{faq.q}</span>
                <span className="transition-transform text-md group-open:rotate-180">
                  ▼
                </span>
              </summary>
